...
## Synopsis
[http://nodejs.org/api/synopsis.html](http://nodejs.org/api/synopsis.html)
...
For more info about node debug, see the [debugger](https://nodejs.org/api/debugger.html) documentation.
...
## Modules
[Official Docs](http://nodejs.org/api/modules.html)
...
## Process
[Official Docs](http://nodejs.org/api/process.html)
...
## Child Process
[Official Docs](http://nodejs.org/api/child_process.html)
...
## Utils
[Official Docs]( http://nodejs.org/api/util.html)
...
## Events
[Official Docs](http://nodejs.org/api/events.html)
...
[Official Docs](http://nodejs.org/api/stream.html)
...
The Readable stream interface is the abstraction for a source of data that you are reading from. In other words, data comes out of a Readable stream. A Readable stream will not start emitting data until you indicate that you are ready to receive it.
...
## File System
[Official Docs](http://nodejs.org/api/fs.html)
...
## HTTP
[Official Docs](http://nodejs.org/api/http.html)
...
## URL
[Official Docs](http://nodejs.org/api/url.html)
...
## Query String
[Official Docs](http://nodejs.org/api/querystring.html)
...
## Assert
[Official Docs](http://nodejs.org/api/assert.html)
...
## OS
[Official Docs](http://nodejs.org/api/os.html)
...
## Buffer
[Official Docs](http://nodejs.org/api/buffer.html)
